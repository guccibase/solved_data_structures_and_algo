...
class BinarySearchTree {
	...
	breadFirstSearchRecursively(queue, list) {
		let q = queue;
		let l = list;
		...
		return this.breadFirstSearchRecursively(q, l);
	}
...
console.log(tree.breadFirstSearchRecursively([ tree.root ], []));
console.log(tree.BFSInOrder());
console.log(tree.BFSPostOrder());
